...
const ServicesPage = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      icon: <Phone className="h-8 w-8 text-blue-5000" />,
    },
    {
      title: "VoIP Services",
      description:
      ...
      icon: <PhoneOutgoing className="h-8 w-8 text-blue-500" />,
    },
  ];
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, idx) => (
          <div
            key={idx}
            className="bg-gradient-to-r from-blue-50 via-white to-blue-50 rounded-3xl p-6 shadow-lg transform transition duration-500 hover:scale-105 hover:shadow-2xl hover:from-indigo-100 hover:to-indigo-50"
          >
